        ...
        <div class="container-xl">
            <div class="row g-2">
                <div class="col-md-4 order-2 order-md-1">
                    ...
                    <div class="fs-600"><p><strong class="fs-500">Celia members have managed recent projects in over 70 countries around the world.</strong></p>
    </div>
                </div>
                <div class="col-md-8 order-1 order-md-2 d-flex justify-content-center align-items-center">
                    <img decoding="async" src="http://celia.local/wp-content/uploads/2024/03/CELIA-Global-Reach-Map.png" alt="">
                </div>
            </div>
        </div>
    </section>
