        ...
        <div class="members_list__card">
            <div class="members_list__card_grid">
                ...
                <div class="members_list__address">
                    ...
                    <div><?=get_field('address',get_the_ID())?></div>
                </div>
                <div class="members_list__contact">
                    <h3 class="fs-400">Contact</h3>
                    <ul class="fa-ul">
                        <li><span class="fa-li"><i class="fa-solid fa-paper-plane text-green-400"></i></span> <a href="mailto:<?=get_field('email',get_the_ID())?>"><?=get_field('email',get_the_ID())?></a></li>
                        <li><span class="fa-li"><i class="fa-solid fa-phone text-green-400"></i></span> <a href="tel:<?=get_field('phone',get_the_ID())?>"><?=get_field('phone',get_the_ID())?></a></li>
                        <li><span class="fa-li"><i class="fa-solid fa-laptop text-green-400"></i></span> <a href="<?=get_field('website',get_the_ID())?>" target="_blank"><?=get_field('website',get_the_ID())?></a></li>

                    </ul>
                </div>
                <div class="members_list__disciplines">
                    <h3 class="fs-400">Disciplines</h3>
                    <div><?=get_field('disciplines',get_the_ID())?></div>
                </div>
            </div>
            <?php
