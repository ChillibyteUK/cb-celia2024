...
function widgets_init()
{
    // register_sidebar(
    //     array(
    //         'name'          => __('Footer Col 1', 'cb-celia2024'),
    //         'id'            => 'footer-1',
    //         'description'   => __('Footer Col 1', 'cb-celia2024'),
    ...
    register_nav_menus(array(
        'primary_nav' => __('Primary Nav', 'cb-celia2024'),
        'footer_menu1' => __('Footer Menu 1', 'cb-celia2024'),
        'footer_menu2' => __('Footer Menu 2', 'cb-celia2024'),
        'footer_menu3' => __('Footer Menu 3', 'cb-celia2024'),
    ));
...
add_action('wp_footer', 'passive_listeners');
